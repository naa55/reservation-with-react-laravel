...
export class TableEdit extends Component {
    ...
    handleSubmit(e) {
            e.preventDefault();
            axios.put('/api/table/' + this.state.id, {
    ...
    componentDidMount() {
        axios
            .get("/api/table/" + this.props.params.id)
            .then((response) => {
                this.setState({ id: response.data.data.id }),
                    this.setState({ name: response.data.data.name }),
                    this.setState({guest: response.data.data.guest})
                    this.setState({status_id: response.data.data.status_id})
            })
...
export default withParams(withNavigation(TableEdit))
