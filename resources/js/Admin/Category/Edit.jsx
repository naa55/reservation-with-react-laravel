...
class CategoryEdit extends Component {
    ...
    handleSubmit(event) {
        ...
        axios
            .post("/api/categories/" + this.state.id, postData)
            .then((response) => this.props.navigate("/admin/categories"))
            .catch((error) =>
    ...
    componentDidMount() {
        axios
            .get("/api/categories/" + this.props.params.id)
            .then((response) => {
...
export default withParams(withNavigation(CategoryEdit));
